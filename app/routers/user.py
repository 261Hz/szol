...
def create_user(
    ...
    # Turnstile is verified once at site entry (see auth.py's
    # /auth/verify-turnstile), not again here -- every visitor already
    # passed the challenge before they could reach this form.
    try:
